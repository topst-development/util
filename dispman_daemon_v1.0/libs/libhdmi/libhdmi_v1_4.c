...
#if (0)
#define DEFAULT_HDMI_LCDC_TIMING	{ 0,  1,  1,  0,  0,  1,  0,  1,  0,  61 ,    639 ,   59 ,     37 ,    0,  0,  5,  479 ,   29,  8,   5,   479 ,    29,  8, 	0,/*640x480p @ 60Hz       25.200MHz   */ }
#else
#define DEFAULT_HDMI_LCDC_TIMING	{ 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   147,     87 ,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3, 	0,/*1920x1080p @ 60Hz     148.5MHz    */ }
#endif

static const struct lcdc_timimg_parms_t LCDCTimimgParams[] =
{                                            		/*  ID  IV  IH  IP  DP  NI TV  TFT STN  LPW     LPC   	LSWC    LEWC   	VDB VDF FPW    FLC  FSWC FEWC FPW2   FLC2  FSWC2 FEWC2 framepacking*/
  /* v640x480p_60Hz         PIXEL_FREQ_25_200,  */    { 0,  1,  1,  0,  0,  1,  0,  1,  0,  61 ,    639 ,   59 ,     37 , 	 0,   0,  5,  479 ,   29,  8,   5,   479 ,    29,  8, 	0,/*640x480p @ 60Hz       25.200MHz   */ },
  /* v720x480p_60Hz         PIXEL_FREQ_27_027,  */    { 0,  1,  1,  0,  0,  1,  0,  1,  0,  61 ,    719 ,   59 ,     15 ,    0,  0,  5,  479 ,   29,  8,   5,   479 ,    29,  8, 	0,/*720x480p @ 60Hz       27.027MHz   */ },
#if defined(MVC_PROCESS)
  /* v1280x720p_60Hz_3D     PIXEL_FREQ_148_500, */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  39 ,    1279,   219,     109,    0,  0,  4,  1469 ,   19,  4,   4,   1469 ,    19,  4, 	1,/*1280x720p @ 60Hz    148.5MHz, 3D Frame packing */ },
#endif
  /* v1280x720p_60Hz        PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  39 ,    1279,   219,     109,    0,  0,  4,  719 ,   19,  4,   4,   719 ,    19,  4, 	0,/*1280x720p @ 60Hz      74.25MHz    */ },
  /* v1920x1080i_60Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  0,  1,  0,  0,  43 ,    1919,   147,     87 ,    0,  0,  9,  1079,   29,  3,   9,   1079,    31,  3, 	0,/*1920x1080i @ 60Hz     74.25MHz    */ },
  /* v720x480i_60Hz         PIXEL_FREQ_27_027,  */    { 0,  1,  1,  0,  1,  0,  1,  0,  0,  123,    1439,   113,     37 ,    0,  0,  5,  479 ,   29,  7,   5,   479 ,    31,  7, 	0,/*720x480i @ 60Hz       27.027MHz   */ },
  ...
  /* v1440x480p_60Hz        PIXEL_FREQ_54_054,  */    {0, 0, 0, 0, 1, 1, 0, 1, 0, 123, 1439, 120, 30, 0, 0, 5, 479, 32, 5, 5, 479, 32, 5, 	0,/*1440x480p @ 60Hz 54.054MHz*/ },
  /* v1920x1080p_60Hz       PIXEL_FREQ_148_500, */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   147,     87 ,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3, 	0,/*1920x1080p @ 60Hz     148.5MHz    */ },
  /* v720x576p_50Hz         PIXEL_FREQ_27,      */    { 0,  1,  1,  0,  0,  1,  0,  1,  0,  63 ,    719 ,   67 ,     11 ,    0,  0,  4,  575 ,   38,  4,   4,   575 ,    38,  4, 	0,/*720x576p @ 50Hz       27MHz       */ },
  /* v1280x720p_50Hz        PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  39 ,    1279,   219,     439,    0,  0,  4,  719 ,   19,  4,   4,   719 ,    19,  4, 	0,/*1280x720p @ 50Hz      74.25MHz    */ },
  /* v1920x1080i_50Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  0,  1,  0,  0,  43 ,    1919,   174,     500,    0,  0,  9,  1079,   29,  3,   9,   1079,    31,  3, 	0,/*1920x1080i @ 50Hz     74.25MHz    */ },
  /* v720x576i_50Hz         PIXEL_FREQ_27,      */    { 0,  1,  1,  0,  1,  0,  1,  0,  0,  125,    1439,   137,     23 ,    0,  0,  5,  575 ,   37,  3,   5,   575 ,    39,  3, 	0,/*720x576i @ 50Hz       27MHz       */ },
  ...
  /* v1440x576p_50Hz        PIXEL_FREQ_54,      */    { 0,  0,  1,  0,  1,  1,  0,  1,  0,  125,    1439,   137,     23 ,    0,  0,  4,  575 ,   38,  4,   4,   575 ,    38,  4, 	0,/*1440x576p @ 50Hz      54MHz       */ },
  /* v1920x1080p_50Hz       PIXEL_FREQ_148_500, */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   174,     500,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3, 	0,/*1920x1080p @ 50Hz     148.5MHz    */ },
  /* v1920x1080p_23.976Hz   PIXEL_FREQ_74_176,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   500,     284,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3, 	0,/*1920x1080p @ 24Hz     74.176MHz    */ },
#if defined(MVC_PROCESS)
  /* v1920x1080p_24Hz_3D    PIXEL_FREQ_148_500, */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   500,     284,    0,  0,  4,  2204,   35,  3,   4,   2204,    35,  3, 	1,/*1920x1080p @ 24Hz     74.25MHz    */ },
#endif
  /* v1920x1080p_24Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   500,     284,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3,	0, /*1920x1080p @ 24Hz     74.25MHz    */ },
  /* v1920x1080p_25Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   430,     244,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3,	0, /*1920x1080p @ 25Hz     74.25MHz    */ },
  /* v1920x1080p_30Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   147,     87 ,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3,	0, /*1920x1080p @ 30Hz     74.25MHz    */ },
  ...
  /* v1280x720p_120Hz       PIXEL_FREQ_148_500, */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  39 ,    1279,   219,     109,    0,  0,  4,  719 ,   19,  4,   4,   719 ,    19,  4,	0, /*1280x720p @ 60Hz      74.25MHz    */ },
  ...
  #if 0
  /* v1360x768p_60Hz        PIXEL_FREQ_84_75,   */    { 0,  0,  0,  0,  0,  1,  0,  1,  0, 111 ,   1359,    63,    255 ,    0,  0,  5,   767,   2,  17,   5,    767,    2,  17,	0, /* 1360x768p @ 60Hz     84.75MHz    */ },
  /* v1360x768p_60Hz        PIXEL_FREQ_84_75,   */    { 0,  0,  0,  0,  0,  1,  0,  1,  0, 135 ,   1359,    71,    207 ,    0,  0,  4,   767,   2,  21,   4,    767,    2,  21,	0, /* 1360x768p @ 60Hz     84.75MHz    */ },
  /* v1366x768p_60Hz        PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  88 ,   1365,    43,     56 ,    0,  0,  5,   767,   2,  17,   5,    767,    2,  17,	0, /* 1366x768p @ 60Hz     84.75MHz    */ },
  /* v1024x768p_60Hz        PIXEL_FREQ_65    ,  */    { 0,  1,  1,  0,  0,  1,  0,  1,  0,  135,   1023,   159,     23 ,    0,  0,  5,   767,  28,   2,   5,    767 ,  28,   2,	0, /*1024x768p @ 60Hz     65.000MHz   */ },
  /*  v854x768p_60Hz        PIXEL_FREQ_37_293,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,   47,    853,   115,     85 ,    0,  0, 19,   479,  33,  28,  19,    479,   33,  28,	0, /*  854x480p @ 60Hz     37.293MHz   */ },
#endif
  /* v1920x1080p_30Hz       PIXEL_FREQ_74_250,  */    { 0,  0,  0,  0,  0,  1,  0,  1,  0,  43 ,    1919,   147,     87 ,    0,  0,  4,  1079,   35,  3,   4,   1079,    35,  3,	0, /*1920x1080p @ 30Hz     74.25MHz    */ },

  /*  ID  IV  IH  IP  DP  NI TV  TFT STN  LPW     LPC     LSWC    LEWC    VDB VDF FPW    FLC  FSWC FEWC FPW2   FLC2  FSWC2 FEWC2 framepacking*/
  #if defined(SUPPORT_SAFE_LINK)
  /* v1920x720p_60Hz       PIXEL_FREQ_88_2, */        { 0,  0,  0,  0,  0,  1,  0,  1,  0,  21 ,    1919,    13,     27 ,    0,  0,  2,   719,    8,  8,   2,   719,      8,  8,        0, /*1920x720p @ 60Hz     88.2MHz    */ },
  #else
  /* v1920x720p_60Hz       PIXEL_FREQ_97_340, */      { 0,  0,  0,  0,  0,  1,  0,  1,  0,  19 ,    1919,    79,     59 ,    0,  0,  0,   719,   56,  1,   0,   719,     56,  1,        0, /*1920x720p @ 60Hz     97.34MHz    */ },
  #endif
};
...
//temp		DPRINTF("%s HDMI_IOC_GET_SUSPEND_STATUS failed!\n",__func__);
		return 0;
	}
...
int HDMIDefaultPhyConfig(void)
{
    ...
    if (!PHYConfig(PHY_FREQ_25_200,HDMI_CD_24))
    {
        DPRINTF("phy config failed!\n");
        return 0;
    }
...
int HDMIStart(void)
{
    ...
    // update UI
    #if defined(TCC_LCDC_HDMI_UI_UPDATE)
...
int HDMISendHPDStatus(void)
{
    ...
    if (ioctl(hdmi_fd,HDMI_IOC_SET_HPD_SWITCH_STATUS, NULL) ) {
        DPRINTF("ioctl(HDMI_IOC_SET_HPD_SWITCH_STATUS) failed!\n");
        return 0;
    }
...
#if defined(HDMI_IOC_ACP_PACKET_CONTROL)
int HDMISetACP(struct HDMIAcpPacketCtrl *acp_packet)
{
        ...
        // get pixel limitation
        if (ioctl(hdmi_fd,HDMI_IOC_ACP_PACKET_CONTROL, acp_packet) < 0) {
                DPRINTF("ioctl(HDMI_IOC_ACP_PACKET_CONTROL) failed!\n");
                return 0;
        }
...
#if defined(HDMI_IOC_ISRC_HEADER_CONTROL)
int HDMISetISRCHeader(struct HDMIIsrcHeaderCtrl *isrc_header)
{
        if ( hdmi_fd == -1 ) {
                DPRINTF("Open file descriptor first!:hdmi_fd\n");
                return 0;
        ...
        // get pixel limitation
        if (ioctl(hdmi_fd, HDMI_IOC_ISRC_HEADER_CONTROL, isrc_header) < 0) {
                DPRINTF("ioctl(HDMI_IOC_ACP_PACKET_CONTROL) failed!\n");
                return 0;
        }
